...
if __name__ == '__main__':
    ...
    data_list = excel_to_list("data.xlsx", "TestToken")  # 读取excel，TestUserLogin工作簿的所有数据
    case_data = get_test_data(data_list, 'TestEnrollmentApplication')  # 查找用例'test_GetAllAsync'的数据
    print(case_data)
